...
const SCENE_FINAL_CUTSCENE := "res://scene/final_cutscene.tscn";
const SCENE_LUNCH_INCIDENT := "res://scene/lunch_cutscene_animated.tscn";
...
const SCENE_END_OF_DAY_PRE_MAIN_GAME := "res://scene/end_of_day_pre_main_game.tscn";
